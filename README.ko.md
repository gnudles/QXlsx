...
- [QXlsx 프로젝트 설정하는 방법](HowToSetProject.ko.md) 참조
	- QXlsx는 정적 또는 동적 라이브러리를 사용하지 않아도 되도록 제작되었습니다.
	- QXlsx 프로젝트를 당신의 프로젝트에 복사하기만 하면 됩니다.
...
- 더 많은 정보는 [테스트된 환경](TestEnv.md)를 참조하세요. 
...
- XMLDOMReader 는 CC BY-ND 4.0 라이센스 또는 상업용 라이센스 입니다 입니다. [https://github.com/j2doll/XMLDOMReader](https://github.com/j2doll/XMLDOMReader)
...
만약 이 프로젝트가 도움이 되셨다면, 저에게 커피 한잔 사주시면 감사하겠습니다!  :joy:
